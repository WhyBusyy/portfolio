...
export const projects: ProjectData[] = [
  {
    ...
    overview: {
      lead: "Chrome Lighthouse 성능 점수를 13점에서 78점으로 개선하며, B2B SaaS 플랫폼의 사용자 경험을 근본적으로 향상시킨 프로젝트입니다.",
      detail:
    ...
    challenges: [
      {
        title: "거대한 초기 번들 사이즈",
        before:
          "모든 페이지와 컴포넌트가 단일 번들로 로드되어 초기 로딩에 10초 이상 소요",
        after:
  ...
  },
  {
    ...
    overview: {
      lead: "프론트엔드와 백엔드 전 과정을 단독으로 개발한 자체 CMS 구축을 통해 운영 효율과 개발 생산성을 동시에 개선한 프로젝트입니다.",
      detail:
    ...
    challenges: [
      ...
      },
      {
        ...
        before:
          "백엔드 리소스가 제한된 환경에서 CMS 전체를 구축해야 하는 상황",
        after:
      ...
      },
      {
        title: "파일 관리 시스템",
        before:
          "이미지와 파일 업로드에 대한 체계적인 관리 시스템 부재",
        after:
  ...
  },
  {
    ...
    overview: {
      lead: "B2B 직거래 통합관리 플랫폼 '플랫팜'의 서비스 초기 설계 단계부터 참여하여, 확장 가능한 프론트엔드 아키텍처를 구축한 프로젝트입니다.",
      detail:
    ...
    metrics: [
      ...
      { value: "100%", change: null, label: "프론트엔드 단독 설계" },
