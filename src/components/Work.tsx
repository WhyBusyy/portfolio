          ...
          items: [
            {
              ...
              period: "2026년 3월 - 현재",
              description:
                "PR마다 90개 이상의 테스트를 자동 실행하고, 변경 diff를 분석해 Playwright 테스트를 AI로 생성·검증하는 QA 봇 설계·구축. 팀의 PR 게이트로 정착해 상시 실행 (Playwright · Claude API)",
          ...
          items: [
            {
              ...
              period: "2026년 3월 ~ 7월",
              description:
                "페이지·컴포넌트마다 적용된 스타일 기준이 달랐던 상태에서, 디자인 측이 정의한 토큰 체계를 코드로 구현하고 따로 마크업된 요소를 공용 컴포넌트로 대체한 뒤 정합 규칙을 만들어 유지보수 기준을 세움 (Frontend)",
